...
async function updateReadme() {
    ...
    const newBadge = `![Distinct Days Active](https://img.shields.io/badge/Distinct%20Days%20Active-${totalActiveDays}-blue?style=for-the-badge)`;
    const badgeRegex = /<p align="center">\s*<a href="https:\/\/github.com\/revida">\s*<img src="https:\/\/img.shields.io\/badge\/Distinct%20Days%20Active-.*?-blue\?style=for-the-badge" alt=".*?"/;
